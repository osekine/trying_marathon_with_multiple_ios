...
import 'example0_test.dart' as example0_test;
import 'example1_test.dart' as example1_test;
import 'example2_test.dart' as example2_test;
...
Future<void> main() async {
  ...
  group('example0_test', example0_test.main);
  group('example1_test', example1_test.main);
  group('example2_test', example2_test.main);
